	...
	return (
		<PageTemplate activeId="profile">
			<div className="flex flex-col gap-y-4 p-4">
				...
				<p>
					By accessing or using our services, you agree to be bound by these Terms. If you disagree, please do not use
					our services.
				</p>
				...
				<p>
					All content and materials on our site are our intellectual property and may not be used without our prior
					written consent.
				</p>
				<h2 className="text-xl font-semibold">4. Termination</h2>
				<p>We may suspend or terminate your access to our services at any time, without prior notice or liability.</p>
