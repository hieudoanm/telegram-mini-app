	...
	return (
		<PageTemplate activeId="news">
			<div className="flex flex-col gap-y-4 p-4">
				{[
					{ id: '1', title: 'Article 1', date: new Date(), content: CONTENT, tags: ['Tag 1', 'Tag 2'] },
					{ id: '2', title: 'Article 2', date: new Date(), content: CONTENT, tags: ['Tag 1', 'Tag 2'] },
					{ id: '3', title: 'Article 3', date: new Date(), content: CONTENT, tags: ['Tag 1', 'Tag 2'] },
					{ id: '4', title: 'Article 4', date: new Date(), content: CONTENT, tags: ['Tag 1', 'Tag 2'] },
				].map(({ id = '', title = '', date = new Date(), content = '', tags = [] }) => {
					return (
						<div key={id} className="rounded-2xl border border-neutral-900 shadow shadow-neutral-900">
							...
							<div className="flex flex-col gap-y-2 p-4">
								...
								<div className="flex items-center gap-x-2">
									{tags.map((tag: string) => {
										return (
											<span key={tag} className="rounded-full bg-yellow-500 px-2 py-0.5 text-xs text-neutral-900">
												{tag}
											</span>
										);
									})}
								</div>
								<p className="line-clamp-3 text-sm text-neutral-300">{content}</p>
								<Link href={`/news/${id}`}>
									<div className="flex items-center gap-x-2">
